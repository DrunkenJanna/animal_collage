...
Author: Delimitry
github: https://github.com/delimitry/collage_maker
"""
...
def make_collage(images, filename, width, init_height):
    ...
    collage_image.save(filename, 'PNG', compress_level=0, optimize=False)
    return True
...
def main():
    ...
    parse.add_argument('-f', '--folder', dest='folder',
    ...
    parse.add_argument('-s', '--shuffle', action='store_true',
                       dest='shuffle', help='enable images shuffle')
